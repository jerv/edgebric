# Edgebric Individual Contributor License Agreement

Thank you for your interest in contributing to Edgebric. This Contributor License Agreement ("Agreement") documents the rights granted by contributors to the Edgebric project.
...
**"Contribution"** means any original work of authorship, including any modifications or additions to an existing work, that you intentionally submit to this project for inclusion in the project. "Submit" means any form of electronic communication sent to the project maintainers, including but not limited to pull requests, issues, and commits.

**"Project"** means the Edgebric software project, maintained by Jerv ("Maintainer").
...
By submitting a pull request to this project, you indicate that you have read, understood, and agree to be bound by the terms of this Agreement. The CLA Assistant bot will record your acceptance.
